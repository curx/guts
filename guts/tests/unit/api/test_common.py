...
NS = "{http://docs.openstack.org/migration/api/v1.1}"
ATOMNS = "{http://www.w3.org/2005/Atom}"
CONF = cfg.CONF


class LimiterTest(test.TestCase):
    """Unit tests for the `guts.api.common.limited` method.
...
class PaginationParamsTest(test.TestCase):
    """Unit tests for `guts.api.common.get_pagination_params` method.
...
class LinkPrefixTest(test.TestCase):
    def test_update_link_prefix(self):
        ...
        result = vb._update_link_prefix("http://192.168.0.243:24/",
                                        "http://127.0.0.1/migration")
        self.assertEqual("http://127.0.0.1/migration", result)
