...
from guts.common import config  # noqa Need to register global_opts
from guts.db import migration
from guts.db.sqlalchemy import api as sqla_api
from guts import i18n
from guts.objects import base as objects_base
from guts import rpc
from guts import service
from guts.tests.unit import conf_fixture
from guts.tests.unit import fake_notifier
...
class TestCase(testtools.TestCase):
    ...
    def setUp(self):
        ...
        p = mock.patch('guts.rpc.get_notifier',
        ...
        rpc.add_extra_exmods("guts.tests.unit")
        ...
        # registry.
        objects_base.GutsObject.indirection_api = None
#        self._base_test_obj_backup = copy.copy(
#            objects_base.GutsObjectRegistry._registry._obj_classes)
...
#            self._base_test_obj_backup
    ...
    def start_service(self, name, host=None, **kwargs):
        ...
        kwargs.setdefault('binary', 'guts-%s' % name)
