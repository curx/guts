...
from guts.api.views import versions as views_versions
        ...
        "media-types": [
            {
                ...
                "type": "application/vnd.openstack.migration+xml;version=1",
            },
            {
                "base": "application/json",
                "type": "application/vnd.openstack.migration+json;version=1",
            }
        ],
    }
}
...
def create_resource():
    return wsgi.Resource(GutsVersion())
